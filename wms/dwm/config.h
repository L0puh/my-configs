...
static const char *fonts[]          = { "Cascadia Code NF:size=10" };
static const char dmenufont[]       = "Cascadia Code NF:size=8";
static const char col_gray1[]       = "#121212"; // bg
static const char col_gray2[]       = "#2f3336"; 
static const char col_gray3[]       = "#d4cfd0"; // fg
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#2b2a2a"; 
...
static const char *translator_dmenu[] = { "translator_dmenu", NULL };
