...
let s:gb.dark0       = ['#121212', 235]     " 40-40-40
...
let s:gb.light0_hard = ['#d4cfd0', 230]     " 249-245-215
let s:gb.light0      = ['#d4cfd0', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#d4cfd0', 223]     " 235-219-178
let s:gb.light2      = ['#d5c4a1', 250]     " 213-196-161
let s:gb.light3      = ['#bdae93', 248]     " 189-174-147
let s:gb.light4      = ['#a89984', 246]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

let s:gb.bright_red     = ['#b0716f', 167]     " 251-73-52
let s:gb.bright_green   = ['#999e98', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#ACA98A', 214]     " 250-189-47
let s:gb.bright_blue    = ['#8AABAC', 109]     " 131-165-152
let s:gb.bright_purple  = ['#9ea6b5', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#bab288', 108]     " 142-192-124
let s:gb.bright_orange  = ['#AC9D8A', 208]     " 254-128-25

let s:gb.neutral_red    = ['#b0716f', 124]     " 204-36-29
